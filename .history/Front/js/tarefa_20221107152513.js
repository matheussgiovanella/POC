    ...
    Swal.fire(
        {
            ...
            html: `<form id="swal-form">` + html + `</form>`,
            focusConfirm: false,
            ...
            preConfirm: async () =>
            {
                try
                {
                    ...
                    const data = await createNew(path, form)
...
const createNew = async (path : string, form : HTMLElement | null) =>
{
    const attributes : [string, FormDataEntryValue][] = await getFormData(form)
